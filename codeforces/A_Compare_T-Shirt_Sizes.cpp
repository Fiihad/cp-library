...
void solve(int cases)
{
    ...
    string u, v;
    cin >> u >> v;
    if (u.back()=='S' && v.back()=='S'){
        if (u.size()>v.size()) print('<');
        else if (u.size()<v.size()) print('>');
        else print('=');
    }
    else if (u.back()=='L' && v.back()=='L'){
        if (u.size()>v.size()) print('>');
        else if (u.size()<v.size()) print('<');
        else print('=');
    }
    else if (u.back()=='S' and v.back()=='L') print('<');
    else if (u.back()=='L' and v.back()=='S') print('>');
    else if (u.back()=='M' or v.back()=='M'){
        if (u.back()=='S' or v.back()=='L') print('<');
        else if (u.back()=='L' or v.back()=='S') print('>');
        else if (u.back()=='M' and v.back()=='M') print('=');
    }
