...
void solve(int cases)
{
    ...
    int size=0, size1=0, flag1=0, flag2=0, temp1=0, temp2=0;
    cin >> in;
    ...
    loop (i,0,n){
        ...
        if (in[i]=='1'){
            if (flag1) temp1++;
            else temp1=1, flag1=1, flag2=0;
            size1 = max(size1, temp1);
        }
        else{
            if (flag2) temp2++;
            else temp2=1, flag2=1, flag1=0;
            size1 = max(size1, temp2);
        }
    }

    print(max(size1*size1, size*(n-size)));
