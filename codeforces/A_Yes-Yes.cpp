...
void solve(int cases)
{
    ...
    string check = "YesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYesYes";

    if (strstr(check.c_str(), in.c_str())) print("YES");
    else print("NO");
